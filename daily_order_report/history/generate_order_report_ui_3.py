#!/usr/bin/env python3
"""
Order Report Generator - PyQt5 Desktop UI (Dark Mode Edition)

Enhancements:
1. Default CSV file picker opens in Downloads folder.
2. Generated report name = Current date (DD-MM-YYYY_HH:SS).txt
3. Default SKU mapping path = ./data/sku_mapping.csv (project-relative).
4. Modern dark mode UI styling.
"""
...
def default_output_path():
    ...
    os.makedirs(downloads_output, exist_ok=True)  # ensure folder exists
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        dark_palette.setColor(QtGui.QPalette.AlternateBase, QtGui.QColor(60, 60, 60))
    ...
    def open_report(self):
        path = default_output_path().strip()
